...
payload = jwt.decode(auth_token, vuln_app.app.config.get('SECRET_KEY'), algorithms=["HS256"], options={"require_iat": True, "require_iss": True, "verify_iss": True}, issuer=vuln_app.app.config.get('JWT_ISSUER'))
            return payload
